  ...
  return (
    ...
    >
      <div className="flex items-start gap-6">
        ...
        {/* Card content */}
        <div className="flex-1 bg-card/60 backdrop-blur-lg hover:bg-card-hover/70 rounded-xl p-6 md:p-8 transition-all duration-300 border border-border hover:border-muted/40 hover:card-shadow group pointer-events-auto">
